...
$fsFlags = @('-DCONFIG_USE_DEFAULT_CFG=1','-DCONFIG_EXT_FEATURE_SET_LVL=2','-DCONFIG_JOURNALING_ENABLE=0','-DCONFIG_XATTR_ENABLE=0','-DCONFIG_EXTENTS_ENABLE=0','-DCONFIG_HAVE_OWN_ERRNO=1','-DCONFIG_DEBUG_PRINTF=0','-DCONFIG_DEBUG_ASSERT=0',"-I$ext4/include",'-Isrc/fs_platform')
$fsObjects = @()
